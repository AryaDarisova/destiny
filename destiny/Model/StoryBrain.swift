...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String) {
        let curStory = stories[storyNum]
        
        if userChoice == curStory.choice1 {
            storyNum = curStory.choice1Destination
        } else if userChoice == curStory.choice2 {
            storyNum = curStory.choice2Destination
        }
        
        isEndOfStory = storyNum == 0
    }
